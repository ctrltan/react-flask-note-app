...
def signup(cur=None):
    ...
    try:
        ...
        try:
            ...
            response.set_cookie('access_token', access_token, max_age=timedelta(minutes=15), httponly=True, samesite='None', secure=False, path='/')
            response.set_cookie('refresh_token', refresh_token, max_age=timedelta(days=30), httponly=True, samesite='None', secure=False, path='/')
...
def logout():
    ...
    try:
        ...
        response.delete_cookie('access_token', samesite='None', secure=False, path='/')
        response.delete_cookie('refresh_token', samesite='None', secure=False, path='/')
